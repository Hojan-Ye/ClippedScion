...
torchrun --standalone --nproc_per_node=4 train_gpt_clippedscion.py --warmdown_iters 1

# ClippedScion
torchrun --standalone --nproc_per_node=4 train_gpt_clippedscion.py --warmdown_iters 1 --unconstrained False
```

- 1B
```bash
# Unconstrained ClippedScion
torchrun --standalone --nproc_per_node=4 train_gpt_clippedscion.py --warmdown_iters 1 --n-embd 2560 --n-head 20 --device-batch-size 16 --rho 6000
```
