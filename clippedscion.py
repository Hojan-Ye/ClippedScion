...
class UnconstrainedClippedScion(torch.optim.Optimizer):
    """Unconstrained ClippedScion optimizer implementation.
    ...
    Example:
        ...
        ...     'scale': radius*60.0,
        ... }]
        >>> optimizer = UnconstrainedClippedScion(optim_groups, lr=2**-12, momentum=0.1, rho = 600.0)
    """
...
class ClippedScion(torch.optim.Optimizer):
    """ClippedScion optimizer implementation.
    ...
    Example:
        ...
        ...     'scale': radius*60.0,
        ... }]
        >>> optimizer = ClippedScion(optim_groups, lr=2**-12, momentum=0.1, rho = 600.0)
    """
    def __init__(self, params, lr=1e-3, momentum=1.0, norm: str='Auto', norm_kwargs: dict=None, scale=1.0, rho=600):
        if lr < 0.0:
            raise ValueError(f"Invalid learning rate: {lr}")
